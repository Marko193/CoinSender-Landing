            ...
            <div className={styles.row_card}>
              <div className={styles.card_content}>
                ...
                <div className={styles.card_text_block}>
                  ...
                  <div className={styles.text_block_description}>
                    Manage employee records and salary payouts to make the
              ...
              <div className={styles.card_content}>
                ...
                <div className={styles.card_text_block}>
                  ...
                  <div className={styles.text_block_description}>
                    ...
                    fund distribution history, ensuring you can easily track
                    your transactions.
                  </div>
                </div>
              </div>
            ...
            <div className={styles.row_card}>
              <div className={styles.card_content}>
                ...
                <div className={styles.card_text_block}>
                  ...
                  <div className={styles.text_block_description}>
                    Our platform also features a customizable invoice creator,
                    so you can efficiently send professional invoices.
                  </div>
                </div>
              </div>
            </div>
