        ...
        <div className={styles.benefits_wrapper}>
          <div className={styles.header}>
            <div className={styles.header_title}>
              Discover the Benefits of Using CoinSender for Your Cryptocurrency
              Payouts
            </div>
            <div className={styles.header_description}>
              When it comes to multi-transaction payouts in cryptocurrency,
              CoinSender is the platform of choice for businesses and projects
              of all sizes.
            </div>
          </div>
            ...
            <div className={styles.content} id={styles.first_row}>
              ...
              <div className={styles.block}>
                <div className={styles.sub_block}>
                  ...
                  <div className={styles.description}>
                    Our platform uses smart contract-based settings for token
                    distribution flows. This ensures that your transactions are
              ...
              <div className={styles.block}>
                <div className={styles.sub_block}>
                  ...
                  <div className={styles.description}>
                    Enjoy transparent tracking of fund distribution history and
                    transaction breakdown, all securely stored on a
              ...
              <div className={styles.block}>
                <div className={styles.sub_block}>
                  ...
                  <div className={styles.description}>
                    The CoinSender team constantly analyzes and upgrades our
                    security systems beyond compliance with current
            ...
            <div className={styles.content} id={styles.second_row}>
              <div className={styles.block}>
                <div className={styles.sub_block}>
                  ...
                  <div className={styles.description}>
                    Send invoices to customers efficiently using our flexible,
                    professional invoice constructor. It’s designed specifically
                    for the crypto industry to make sure you look sharp.
                  </div>
                </div>
              </div>
              <div className={styles.block}>
                <div className={styles.sub_block}>
                  ...
                  <div className={styles.description}>
                    CoinSender supports multiple networks, including Ethereum,
                    Binance Smart Chain, and Polygon, making it easy to
                    distribute tokens across different networks.
                  </div>
                </div>
              </div>
              <div className={styles.block}>
                <div className={styles.sub_block}>
                  ...
                  <div className={styles.description}>
                    Save time with automated processes for recipient list
                    collection. Our simple step-by-step process will save you
                    time and reduce your errors.
                  </div>
                </div>
              </div>
              <div className={styles.block}>
                <div className={styles.sub_block}>
                  ...
                  <div className={styles.description}>
                    Any cryptocurrency transaction requires computational
                    resources, and GAS is the fee that covers the cost of those.
                    So by bringing your transactions together with CoinSender,
                    you can make big savings on GAS.
                  </div>
                </div>
              </div>
            </div>
