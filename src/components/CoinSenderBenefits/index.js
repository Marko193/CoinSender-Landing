        ...
        <div className={styles.benefits_container}>
            <div className={styles.benefits_wrapper}>
                <div className={styles.header}>
                    <div className={styles.header_title}>Discover the Benefits of Using CoinSender for Your
                        Cryptocurrency
                        Payouts
                    </div>
                    <div className={styles.header_description}>When it comes to multi-transaction payouts in
                        cryptocurrency,
                        CoinSender is the platform of choice for businesses and projects of all sizes.
                    </div>
                </div>
